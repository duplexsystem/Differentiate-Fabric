...
public class LogSlabBlock extends SlabBlock implements IFlammableBlock {
	...
	public LogSlabBlock(Settings settings) {
		this(null, settings);
	}
	
	public LogSlabBlock(Settings settings, boolean isNetherWood) {
	...
	public LogSlabBlock(Block strippedBlock, Settings settings, boolean isNetherWood) {
		super(settings);
